...
<div class="col-{{ $nCol }} no-gutters" style="font-size:0.65rem">
  <div class="card mt-0 mb-1 p-0 mx-0">
    <h4 class="card-header m-0 p-0">Avisos</h4>
    <div class="card-body m-0 p-0">
        <a href="{{ route('avisos.crear') }}" class="btn btn-primary my-0 py-0 mx-2">
        @if ($movil)
            Crear
        @else
            Crear Aviso
  ...
  <div class="card mt-1 mb-0 mx-0 p-0">
    ...
    <div class="card-body m-0 p-0">
        <form method="POST" class="form-horizontal" action="{{ route('avisos.post') }}">
            {!! csrf_field() !!}
